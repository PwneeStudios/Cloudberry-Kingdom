...
namespace CloudberryKingdom
{
    public class GUI_Timer_Base : GUI_Panel
    {
        ...
        public GUI_Timer_Base()
        {
            ...
            TimerText = new EzText(BuildString().ToString(), Tools.Font_Dylan60, 450, true, true);
            TimerText.Scale = .55f;
            TimerText.MyFloatColor = new Color(255, 255, 255).ToVector4();
            TimerText.OutlineColor = new Color(0, 0, 0).ToVector4();
