...
namespace EasyStorage
{
	...
	public abstract partial class SaveDevice : IGameComponent, IUpdateable, IAsyncSaveDevice
	{
		...
		/// </summary>
		public static string Err_PromptForCancelledMessage
		{
		...
		/// </summary>
		public static string Err_ForceCancelledReselectionMessage
		{
		...
		/// disconnected.
		/// </summary>
		public static string Err_PromptForDisconnectedMessage
		{
		...
		/// </summary>
		public static string Err_ForceDisconnectedReselectionMessage
		{
		...
		/// a storage device.
		/// </summary>
		public static string Err_StorageDeviceRequired
		{
		...
		/// </summary>
		public static string Err_ReselectStorageDevice
		{
		...
		/// </summary>
		public static string Err_YesSelectNewDevice
		{
		...
		/// if they want to select a storage device.
		/// </summary>
		public static string Err_NoContinueWithoutDevice
		{
