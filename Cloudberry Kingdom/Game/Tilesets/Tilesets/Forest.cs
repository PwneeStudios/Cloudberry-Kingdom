...
info.FallingBlocks.Group.Add(new PieceQuad(103, "fblock_forest", -3, 3, 2));

sprite_anim("Bouncy_Forest", "Bouncy_Forest", 1, 3, 2);
info.BouncyBlocks.Group.Add(new PieceQuad(124, "bouncy_Forest", -6, 6, 13));
...
info.MovingBlocks.Group.Add(new PieceQuad(190, "movingblock_forest_190_v2", -1, 1, 1));
info.MovingBlocks.Group.Add(new PieceQuad(150, "movingblock_forest_150", -1, 1, 1));
info.MovingBlocks.Group.Add(new PieceQuad(135, "movingblock_forest_135_v2", -1, 1, 1));
info.MovingBlocks.Group.Add(new PieceQuad(80, "movingblock_forest_80_v2", -1, 1, 1));
info.MovingBlocks.Group.Add(new PieceQuad(40, "movingblock_forest_40_v2", -1, 1, 1));
...
info.SpikeyGuys.Ball.Size = new Vector2(160, -1);
...
info.Orbs.Ball.Sprite = "floater_spikey_forest";
info.Orbs.Ball.Size = new Vector2(150, -1);
info.Orbs.Ball.Offset = new Vector2(0, -22);
info.Orbs.Base.Sprite = null;
info.Orbs.Rotate = true;
info.Orbs.Radius = 130;
info.Orbs.RotateOffset = .05f;
info.Orbs.Chain.Sprite = "floater_chain_forest";
info.Orbs.Chain.Width = 55;
info.Orbs.Chain.RepeatWidth = 1900;

info.Orbs.Ball.Sprite = "floater_buzzsaw_forest";
info.Orbs.Ball.Size = new Vector2(230, -1);
