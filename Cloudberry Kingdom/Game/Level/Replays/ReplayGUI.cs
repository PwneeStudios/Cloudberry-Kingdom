    ...
    public class ReplayGUI : CkBaseMenu
    {
		...
		public override void OnAdd()
		{
			...
			if (Type == ReplayGUIType.Computer)
			{
				...
				{
					////////////////////////////////////////////////////////////////////////////////
					/////// Console version, compuer replay ////////////////////////////////////////
					////////////////////////////////////////////////////////////////////////////////
					...
					_q = MyPile.FindQuad("Button_LR"); if (_q != null) { _q.Pos = new Vector2(186.1109f, -900.0001f); _q.Size = new Vector2(84.56654f, 84.56654f); }
					_q = MyPile.FindQuad("Button_LB"); if (_q != null) { _q.Pos = new Vector2(655.555f, -908.3333f); _q.Size = new Vector2(152.0833f, 152.0833f); }
					_q = MyPile.FindQuad(""); if (_q != null) { _q.Pos = new Vector2(1210.557f, 791.1111f); _q.Size = new Vector2(355f, 124.25f); }
			...
			else
			{
				if (ButtonCheck.ControllerInUse)
				{
					...
					if (Localization.CurrentLanguage.MyLanguage == Localization.Language.Japanese)
					{
						...
						_t = MyPile.FindEzText("Back"); if (_t != null) { _t.Pos = new Vector2(-530.5558f, -824.9999f); _t.Scale = 0.4147499f; }
						_t = MyPile.FindEzText("Toggle"); if (_t != null) { _t.Pos = new Vector2(16.66613f, -827.7778f); _t.Scale = 0.4102498f; }
						_t = MyPile.FindEzText("Speed"); if (_t != null) { _t.Pos = new Vector2(408.333f, -838.8885f); _t.Scale = 0.3873335f; }
						_t = MyPile.FindEzText("Prev"); if (_t != null) { _t.Pos = new Vector2(955.5559f, -827.7777f); _t.Scale = 0.4208333f; }
						_t = MyPile.FindEzText("Next"); if (_t != null) { _t.Pos = new Vector2(1399.999f, -824.9999f); _t.Scale = 0.4305f; }
						...
						_q = MyPile.FindQuad("Button_X"); if (_q != null) { _q.Pos = new Vector2(-225f, -908.3333f); _q.Size = new Vector2(65.58324f, 65.58324f); }
						_q = MyPile.FindQuad("Button_LR"); if (_q != null) { _q.Pos = new Vector2(327.7776f, -902.7777f); _q.Size = new Vector2(72.98328f, 72.98328f); }
						_q = MyPile.FindQuad("Button_LB"); if (_q != null) { _q.Pos = new Vector2(738.8892f, -908.3331f); _q.Size = new Vector2(103.1499f, 103.1499f); }
						_q = MyPile.FindQuad("Button_RB"); if (_q != null) { _q.Pos = new Vector2(1188.889f, -908.3333f); _q.Size = new Vector2(107.5665f, 107.5665f); }
						_q = MyPile.FindQuad(""); if (_q != null) { _q.Pos = new Vector2(1277.222f, 774.4444f); _q.Size = new Vector2(255f, 128.775f); }
						_q = MyPile.FindQuad(""); if (_q != null) { _q.Pos = new Vector2(1277.222f, 774.4444f); _q.Size = new Vector2(255f, 128.775f); }
