...
namespace CloudberryKingdom
{
    public class StartMenu_MW_Backpanel : CkBaseMenu
    {
        ...
        protected QuadClass Scene, Title, TM, Title_Trim, Scene_NoBob_Blur, Scene_Blur, Scene_Princess, Scene_NoBob_Brighten,
                    Scene_Kobbler, Scene_Kobbler_Blur;
        protected EzText VersionText;
        ...
        protected virtual void Setup()
        {
            ...
            VersionText = new EzText(CloudberryKingdomGame.VersionString, Resources.Font_Grobold42);
            VersionText.Alpha = 0;
        ...
        public void SetState(TitleBackgroundState state)
        {
            ...
            switch (state)
            {
                ...
                case TitleBackgroundState.Scene_Blur:
                    if (MyState == TitleBackgroundState.Scene_Title) Scene.Show = true;
                    if (MyState == TitleBackgroundState.Scene_StoryMode) Scene_Princess.Show = true;
                ...
                case TitleBackgroundState.Scene_Blur_Dark:
                    ...
                    if (MyState == TitleBackgroundState.None)
                    {
                        Scene_Blur.Alpha = 0;
                        Scene_Blur.Fade(.025f);
                        Scene_Blur.Show = true;
                    }
                    else if (MyState == TitleBackgroundState.Scene_Blur)
                    {
                        Scene_Blur.Fade(.25f);
                        Scene_Blur.Show = true;
                    }
        ...
        protected override void MyDraw()
        {
            ...
            if (MyState == TitleBackgroundState.Scene_Blur_Dark)
