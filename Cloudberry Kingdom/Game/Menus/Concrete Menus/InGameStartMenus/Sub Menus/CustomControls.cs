...
namespace CloudberryKingdom
{
    ...
    public class ControlItem : MenuItem
    {
        ...
        public ControlItem(string description, Keys key)
            : base(new EzText(description, Tools.Font_Grobold42, 2000, false, false, .65f))
        {
            MyKey = key;
    ...
    public class CustomControlsMenu : CkBaseMenu
    {
        ...
        public void MakeInstructions()
        {
            ...
            var text = new EzText("Press any key to switch control of selected item.", Tools.Font_Grobold42, 700, true, true, .675f);
            text.Scale *= .68f;
