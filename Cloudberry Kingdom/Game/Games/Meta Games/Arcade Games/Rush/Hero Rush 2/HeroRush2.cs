...
namespace CloudberryKingdom
{
    public class Challenge_HeroRush2 : Challenge_HeroRush
    {
        ...
        protected Challenge_HeroRush2()
        {
            ...
            Hero_MoveMod[] MoveTypes = new Hero_MoveMod[]
                { Hero_MoveMod.Classic, Hero_MoveMod.Double, Hero_MoveMod.Jetpack };
        ...
        {
            Challenge_HeroRush2 ch;
            public OnSwapLambda(Challenge_HeroRush2 ch)
            {
                this.ch = ch;
            }
            ...
            {
                data.MyGame.AddGameObject(new HeroRush2_Tutorial(ch));
            }
        }
    }
}