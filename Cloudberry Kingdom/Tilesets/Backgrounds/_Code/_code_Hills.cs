...
namespace CloudberryKingdom
{
    public partial class Background : ViewReadWrite
    {
        public static void _code_Hills(Background b)
        {
            ...
            __2.MyQuad.Base = new Drawing.BasePoint(81277.7f, 0f, 0f, 34106.41f, -4469.055f, 784.0586f);

            __2.uv_speed = new Vector2(0f, 0f);
            __2.uv_offset = new Vector2(0f, 0f);
            __2.Data = new PhsxData(-4469.055f, 784.0586f, 0f, 0f, 0f, 0f);
            __2.StartData = new PhsxData(-4469.055f, 784.0586f, 0f, 0f, 0f, 0f);
            ...
            __3.MyQuad.Base = new Drawing.BasePoint(81277.7f, 0f, 0f, 34106.41f, 158086.3f, 784.0586f);
            ...
            __5.Name = "hills_backcastles_p1_0";
            __5.MyQuad.Quad._MyTexture = Tools.Texture("hills_backcastles");
            ...
            __5.MyQuad.Base = new Drawing.BasePoint(24216.64f, 0f, 0f, 10152.61f, -878.5039f, 235.2168f);

            __5.uv_speed = new Vector2(0f, 0f);
            __5.uv_offset = new Vector2(0f, 0f);
            __5.Data = new PhsxData(-878.5039f, 235.2168f, 0f, 0f, 0f, 0f);
            __5.StartData = new PhsxData(-878.5039f, 235.2168f, 0f, 0f, 0f, 0f);
            __4.Floaters.Add(__5);

            CloudberryKingdom.BackgroundFloater __6 = new CloudberryKingdom.BackgroundFloater();
            __6.Name = "hills_backcastles_p2_0";
            __6.MyQuad.Quad._MyTexture = Tools.Texture("hills_backcastles_p2");
            ...
            __6.MyQuad.Base = new Drawing.BasePoint(24216.64f, 0f, 0f, 10152.61f, 47554.79f, 235.2168f);

            __6.uv_speed = new Vector2(0f, 0f);
            __6.uv_offset = new Vector2(0f, 0f);
            __6.Data = new PhsxData(47554.79f, 235.2168f, 0f, 0f, 0f, 0f);
            __6.StartData = new PhsxData(47554.79f, 235.2168f, 0f, 0f, 0f, 0f);
            ...
            __8.MyQuad.Base = new Drawing.BasePoint(10593.01f, 0f, 0f, 4445.094f, 2926.976f, 102.2695f);
            ...
            __9.MyQuad.Base = new Drawing.BasePoint(10593.01f, 0f, 0f, 4445.094f, 24113f, 102.2695f);
            ...
            __10.MyQuad.Base = new Drawing.BasePoint(10593.01f, 0f, 0f, 4445.094f, 39921.59f, 451.0566f);
            ...
            __11.MyQuad.Base = new Drawing.BasePoint(10593.01f, 0f, 0f, 4445.094f, 61107.63f, 451.0566f);
            ...
            __13.Name = "hills_backhills2_p1_0";
            __13.MyQuad.Quad._MyTexture = Tools.Texture("hills_backhills2");
            ...
            __13.MyQuad.Base = new Drawing.BasePoint(7862.345f, 0f, 0f, 3299.248f, 2234.674f, 75.87695f);

            __13.uv_speed = new Vector2(0f, 0f);
            __13.uv_offset = new Vector2(0f, 0f);
            __13.Data = new PhsxData(2234.674f, 75.87695f, 0f, 0f, 0f, 0f);
            __13.StartData = new PhsxData(2234.674f, 75.87695f, 0f, 0f, 0f, 0f);
            __12.Floaters.Add(__13);

            CloudberryKingdom.BackgroundFloater __14 = new CloudberryKingdom.BackgroundFloater();
            __14.Name = "hills_backhills2_p2_0";
            __14.MyQuad.Quad._MyTexture = Tools.Texture("hills_backhills2_p2");
            ...
            __14.MyQuad.Base = new Drawing.BasePoint(7862.345f, 0f, 0f, 3299.248f, 17959.37f, 75.87695f);

            __14.uv_speed = new Vector2(0f, 0f);
            __14.uv_offset = new Vector2(0f, 0f);
            __14.Data = new PhsxData(17959.37f, 75.87695f, 0f, 0f, 0f, 0f);
            __14.StartData = new PhsxData(17959.37f, 75.87695f, 0f, 0f, 0f, 0f);
            __12.Floaters.Add(__14);

            CloudberryKingdom.BackgroundFloater __15 = new CloudberryKingdom.BackgroundFloater();
            __15.Name = "hills_backhills2_p1_0";
            __15.MyQuad.Quad._MyTexture = Tools.Texture("hills_backhills2");
            ...
            __15.MyQuad.Base = new Drawing.BasePoint(7862.345f, 0f, 0f, 3299.248f, 30245.78f, -199.5762f);

            __15.uv_speed = new Vector2(0f, 0f);
            __15.uv_offset = new Vector2(0f, 0f);
            __15.Data = new PhsxData(30245.78f, -199.5762f, 0f, 0f, 0f, 0f);
            __15.StartData = new PhsxData(30245.78f, -199.5762f, 0f, 0f, 0f, 0f);
            __12.Floaters.Add(__15);

            CloudberryKingdom.BackgroundFloater __16 = new CloudberryKingdom.BackgroundFloater();
            __16.Name = "hills_backhills2_p2_0";
            __16.MyQuad.Quad._MyTexture = Tools.Texture("hills_backhills2_p2");
            ...
            __16.MyQuad.Base = new Drawing.BasePoint(7862.345f, 0f, 0f, 3299.248f, 45970.47f, -199.5762f);

            __16.uv_speed = new Vector2(0f, 0f);
            __16.uv_offset = new Vector2(0f, 0f);
            __16.Data = new PhsxData(45970.47f, -199.5762f, 0f, 0f, 0f, 0f);
            __16.StartData = new PhsxData(45970.47f, -199.5762f, 0f, 0f, 0f, 0f);
            ...
            __18.MyQuad.Quad.v0.Vertex = new MyOwnVertexFormat(new Vector2(-4171.699f, 2314.272f), new Vector2(0f, 0f), new Color(255, 255, 255, 255));
            __18.MyQuad.Quad.v0.Pos = new Vector2(-1f, 1f);

            __18.MyQuad.Quad.v1.Vertex = new MyOwnVertexFormat(new Vector2(40964.18f, 2314.272f), new Vector2(2.998478f, 0f), new Color(255, 255, 255, 255));
            __18.MyQuad.Quad.v1.Pos = new Vector2(1f, 1f);

            __18.MyQuad.Quad.v2.Vertex = new MyOwnVertexFormat(new Vector2(-4171.699f, -1292.736f), new Vector2(0f, 1f), new Color(255, 255, 255, 255));
            __18.MyQuad.Quad.v2.Pos = new Vector2(-1f, -1f);

            __18.MyQuad.Quad.v3.Vertex = new MyOwnVertexFormat(new Vector2(40964.18f, -1292.736f), new Vector2(2.998478f, 1f), new Color(255, 255, 255, 255));
            ...
            __18.MyQuad.Base = new Drawing.BasePoint(22567.94f, 0f, 0f, 1803.504f, 18396.24f, 510.7676f);
            ...
            __20.MyQuad.Base = new Drawing.BasePoint(5711.815f, 0f, 0f, 1410.282f, 8635.98f, -926.418f);
            ...
            __21.MyQuad.Base = new Drawing.BasePoint(5250.666f, 0f, 0f, 1960.848f, 34.27734f, -34.0918f);
            ...
            __22.MyQuad.Base = new Drawing.BasePoint(5250.666f, 0f, 0f, 1960.848f, 17604.08f, -34.0918f);
            ...
            __23.MyQuad.Base = new Drawing.BasePoint(4082.421f, 0f, 0f, 1469.273f, 10419.8f, -1173.33f);
            ...
            __24.MyQuad.Base = new Drawing.BasePoint(5711.815f, 0f, 0f, 1410.282f, 27956.91f, -438.7754f);
            ...
            __25.MyQuad.Base = new Drawing.BasePoint(5250.666f, 0f, 0f, 1960.848f, 34432.56f, -336.752f);
            ...
            __26.MyQuad.Base = new Drawing.BasePoint(5711.815f, 0f, 0f, 1410.282f, 43620.78f, -565.0293f);
            ...
            __28.MyQuad.Base = new Drawing.BasePoint(646.1251f, 0f, 0f, 486.9349f, -8483.381f, -959.5684f);
            ...
            __29.MyQuad.Base = new Drawing.BasePoint(974.2943f, 0f, 0f, 843.0762f, -6522.573f, -951.364f);

            __29.uv_speed = new Vector2(0f, 0f);
            __29.uv_offset = new Vector2(0f, 0f);
            __29.Data = new PhsxData(-6522.573f, -951.364f, 0f, 0f, 0f, 0f);
            __29.StartData = new PhsxData(-6522.573f, -951.364f, 0f, 0f, 0f, 0f);
            ...
            __30.MyQuad.Base = new Drawing.BasePoint(892.2518f, 0f, 0f, 804.9318f, -4241.801f, -1058.019f);

            __30.uv_speed = new Vector2(0f, 0f);
            __30.uv_offset = new Vector2(0f, 0f);
            __30.Data = new PhsxData(-4241.801f, -1058.019f, 0f, 0f, 0f, 0f);
            __30.StartData = new PhsxData(-4241.801f, -1058.019f, 0f, 0f, 0f, 0f);
            ...
            __31.MyQuad.Base = new Drawing.BasePoint(957.8854f, 0f, 0f, 524.0001f, -2026.664f, -1213.899f);
            ...
            __32.MyQuad.Base = new Drawing.BasePoint(695.9648f, 0f, 0f, 565.1686f, -4.105469f, -1058.24f);
            ...
            __33.MyQuad.Base = new Drawing.BasePoint(1266.809f, 0f, 0f, 1009.208f, 2359.654f, -917.8555f);
            ...
            __34.MyQuad.Base = new Drawing.BasePoint(646.1251f, 0f, 0f, 486.9349f, 4476.271f, -1029.628f);
            ...
            __35.MyQuad.Base = new Drawing.BasePoint(974.2943f, 0f, 0f, 843.0762f, 6329.44f, -981.4927f);
            ...
            __36.MyQuad.Base = new Drawing.BasePoint(892.2518f, 0f, 0f, 804.9318f, 8591.752f, -933.3588f);
            ...
            __37.MyQuad.Base = new Drawing.BasePoint(957.8854f, 0f, 0f, 524.0001f, 10830f, -1125.896f);
            ...
            __38.MyQuad.Base = new Drawing.BasePoint(695.9648f, 0f, 0f, 565.1686f, 13020.1f, -1053.695f);
            ...
            __39.MyQuad.Base = new Drawing.BasePoint(1266.809f, 0f, 0f, 1009.208f, 15234.28f, -933.358f);
            ...
            __40.MyQuad.Base = new Drawing.BasePoint(646.1251f, 0f, 0f, 486.9349f, 17219.33f, -986.3066f);
            ...
            __41.MyQuad.Base = new Drawing.BasePoint(974.2943f, 0f, 0f, 843.0762f, 19203.91f, -1006.042f);
            ...
            __42.MyQuad.Base = new Drawing.BasePoint(892.2518f, 0f, 0f, 804.9318f, 21566.81f, -1132.153f);
            ...
            __43.MyQuad.Base = new Drawing.BasePoint(957.8854f, 0f, 0f, 524.0001f, 23854.63f, -1173.068f);
            ...
            __44.MyQuad.Base = new Drawing.BasePoint(695.9648f, 0f, 0f, 565.1686f, 25828.14f, -1124.934f);
            ...
            __45.MyQuad.Base = new Drawing.BasePoint(1266.809f, 0f, 0f, 1009.208f, 28090.46f, -860.1955f);
