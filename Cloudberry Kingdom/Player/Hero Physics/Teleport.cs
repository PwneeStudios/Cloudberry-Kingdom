...
namespace CloudberryKingdom
{
    public class BobPhsxTeleport : BobPhsxNormal
    {
        ...
        protected override void InitSingleton()
        {
            ...
            Name = "Wizard";
            //Icon = new PictureIcon(Tools.TextureWad.FindByName("HeroIcon_Big"), Color.White, DefaultIconWidth);
            Icon = new PictureIcon(Tools.TextureWad.FindByName("HeroIcon_Classic"), Color.White, DefaultIconWidth * 1.4f);
        }
        static readonly BobPhsxTeleport instance = new BobPhsxTeleport();
        new public static BobPhsxTeleport Instance { get { return instance; } }
