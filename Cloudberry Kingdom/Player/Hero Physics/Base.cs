...
namespace CloudberryKingdom
{
    ...
    public class BobPhsx
    {
        ...
        {
            public static CoreSound DoubleJump_Sound = Tools.NewSound("Jump5", .1f);
            public static CoreSound BobBoxJump_Sound = Tools.NewSound("BoxHero_Land", 1);
            public static CoreSound BobJetpack_Sound = Tools.NewSound("Jetpack", .15f);
