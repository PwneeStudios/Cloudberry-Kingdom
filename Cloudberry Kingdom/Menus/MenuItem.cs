...
namespace CloudberryKingdom
{
    ...
    public class MenuItem : IViewable
    {
        ...
        public bool PredefinedText = false;
        ...
        public String deprecated_MySelectedString, deprecated_MyString;
        ...
        /// Deprecated.
        /// </summary>
        public MenuItem(String str, EzFont font, int Width)
        {
            DeprecatedInit(str, font, font, Width);
        }
        public MenuItem(String str, EzFont font, EzFont selectedfont, int Width)
        {
            DeprecatedInit(str, font, selectedfont, Width);
        }
        public MenuItem(String str, EzFont font)
        {
            DeprecatedInit(str, font, font, 0);
        }
        public MenuItem(String str, EzFont font, EzFont selectedfont)
        {
            DeprecatedInit(str, font, selectedfont, 0);
        }
        ...
        {
            //MyOscillateParams.Set(2f, 1.03f, .09f);
        ...
        void DeprecatedInit(String str, EzFont font, EzFont selectedfont, int Width)
        {
            this.TextWidth = Width;

            OverrideA = true;

            deprecated_MySelectedString = deprecated_MyString = str;

            Init(str, font, selectedfont, Width);
            SetToDefaultColors();

            MyFont = font;
            MySelectedFont = selectedfont;
        }


        public void Init(String str, EzFont font, EzFont selectedfont)
        {
            Init(str, font, selectedfont, 0);
        }
        public void Init(String str, EzFont font, EzFont selectedfont, int Width)
        {
            MyFont = font;
            MySelectedFont = selectedfont;
            deprecated_MySelectedString = deprecated_MyString = str;
        ...
        public void MakeText() { MakeText(0); }
        public void MakeText(int Width)
        {
            if (Width > 0)
            {
                MyText = new EzText(deprecated_MyString, MyFont, Width, true, true);
                MySelectedText = new EzText(deprecated_MyString, MySelectedFont, Width, true, true);
            }
            else
            {
                MyText = new EzText(deprecated_MyString, MyFont, true, true);
                MySelectedText = new EzText(deprecated_MyString, MySelectedFont, true, true);
            }
        }
        ...
        public void SetTextSelection(bool Selected)
        {
            ...
            {
                //Vector2 HoldPos = MyText.Pos;
                bool HoldFixed = MyText.FixedToCamera;
                if (TextWidth > 0)
                {
                    if (Selected)
                        MyText = new EzText(deprecated_MySelectedString, MySelectedFont, TextWidth, true, true);
                    else
                        MyText = new EzText(deprecated_MyString, MyFont, TextWidth, true, true);
                }
                else
                {
                    if (Selected)
                        MyText = new EzText(deprecated_MySelectedString, MySelectedFont, true, true);
                    else
                        MyText = new EzText(deprecated_MyString, MyFont, true, true);
                }
                //MyText.Pos = HoldPos;
                MyText.FixedToCamera = HoldFixed;
            }
            this.Selected = Selected;

            float HoldAlpha = MyText.MyFloatColor.W;
            if (Selected)
            {
                MyText.MyFloatColor = MySelectedColor;
            }
            else
            {
                MyText.MyFloatColor = MyColor;
            }
            MyText.MyFloatColor.W = HoldAlpha;
        }
