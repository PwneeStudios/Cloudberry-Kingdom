...
namespace CloudberryKingdom
{
    public class GameOverPanel : StartMenuBase
    {
        ...
        void Create()
        {
            ...
            // 'Game Over' text
            EzText Text = new EzText("Game Over", Tools.Font_Dylan60, 1450, false, true, .6f);
            Text.Scale = .8f;
        ...
        protected override void SetHeaderProperties(EzText text)
        {
            ...
            //text.MyFloatColor = new Color(253, 253, 52).ToVector4();
        ...
        void MakeMenu()
        {
            ...
            item.Go = _item => Action_ShowHighScores();
            AddItem(item);
