        ...
        public AwardmentMessage(Awardment award)
        {
            ...
            if (Style == 0)
            {
                if (award.Unlockable == null)
                    //Title = new EzText("Game unlocked:", Tools.Font_Dylan60, 1800, false, false, .575f);
                    Title = new EzText("", Tools.Font_Dylan60, 1800, false, false, .575f);
                else
                    Title = new EzText("Awardment unlocked:", Tools.Font_Dylan60, 1800, false, false, .575f);
                Title.Pos =
            ...
            {
                Title = new EzText("Awardment", Tools.Font_Dylan60, 1800, false, false, .575f);
                Title.Pos = new Vector2(-1690.476f, 468.254f);
                Title.Scale *= .82f;
                MyPile.Add(Title);

                Title = new EzText("unlocked:", Tools.Font_Dylan60, 1800, false, false, .575f);
