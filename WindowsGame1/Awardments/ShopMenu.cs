...
namespace CloudberryKingdom.Awards
{
    ...
    public class ShopMenu : StartMenuBase
    {
        ...
        void CharSelect()
        {
            ...
            {
                CharacterSelectManager.ParentPanel = this;
#if PC_VERSION
        ...
        public ShopMenu()
        {
            ...
            // Header
            MenuItem Header = new MenuItem(new EzText("Hats for sale!", Tools.Font_Dylan60));
            MyMenu.Add(Header);
            Header.Pos =
        ...
        {
            Header = new MenuItem(new EzText(str, Tools.Font_Dylan60));
            MyMenu.Add(Header);
            ItemPos.Y -= 40;
        ...
        void MakeRest()
        {
            ...
            Bank = new EzText("Bank", Tools.Font_DylanThin42);
            Bank.Scale *= 1.1f;
            CampaignMenu.UnpleasantColor(Bank);
            MyPile.Add(Bank);
            Bank.Pos = new Vector2(100f, 919.0476f);

            BankAmount = new EzText("xx", Tools.Font_DylanThin42);
