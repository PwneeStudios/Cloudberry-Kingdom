    ...
    public class DifficultyGroups
    {
        ...
        static void MakeDownUpgrades()
        {
            ...
            f.Add((u, D) =>
            {
                ...
                u[Upgrade.Laser] = D(0,2,3.3, 6.3, 8.3);
            });
            ...
            f.Add((u, D) =>
            {
                ...
                u[Upgrade.SpikeyLine] = D(0, 2,3.3, 6.3, 8.3);
            });
        }
        ...
        static void MakeEasyUpgrades()
        {
            ...
            f.Add((u, D) =>
            {
                u[Upgrade.Jump] =           D(2, 4.8,   8.2, 8.5, 10);
            ...
            f.Add((u, D) =>
            {
                u[Upgrade.Jump] =      D(4, 1, 0, 0,   0);
                u[Upgrade.SpikeyGuy] = D(0,3.2,5.5,8,   10);
                u[Upgrade.Pinky] =     D(2, 3,5.5, 8,   10);
            ...
            f.Add((u, D) =>
            {
                ...
                u[Upgrade.Elevator] =       D(3,   5,   7,   9,    9);
                u[Upgrade.MovingBlock] =    D(2,   3,   3,   3,    3);
            });

            f.Add((u, D) =>
            {
                u[Upgrade.SpikeyLine] =     D(1,   2,   4, 8.4, 9.5);
            ...
            f.Add((u, D) =>
            {
                u[Upgrade.SpikeyGuy] =      D(1,   3, 4.5, 7.6,  9.5);
                u[Upgrade.Speed] =          D(1,   3, 3.5,   8,   10);
                u[Upgrade.Elevator] =       D(3.5, 6,   7,   9,    9);
            ...
            f.Add((u, D) =>
            {
                ...
                u[Upgrade.FallingBlock] =   D(4,   2,   2,   3,    4);
        ...
        static void MakeNormalUpgrades()
        {
            ...
            f.Add((u, D) =>
            {
                u[Upgrade.Jump] =        D(-1,4.8,8.5, 9,  10);
            ...
            f.Add((u, D) =>
            {
                u[Upgrade.Jump] =       D(-1, 5.1, 8.5,   9,   10);
