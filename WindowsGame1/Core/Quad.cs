...
namespace Drawing
{
    public class Quad : BaseQuad
    {
        ...
        void ModifyAxis(ObjectVector axis, int anim, int frame)
        {
        ...
        void ModifyPoint(ObjectVector point, int anim, int frame)
        {
        ...
        public void ModifyAllRecords(int anim, int frame)
        {
            for (int i = 0; i < 4; i++)
                ModifyAxis(Corner[i], anim, frame);

            ModifyAxis(xAxis, anim, frame);
            ModifyAxis(yAxis, anim, frame);

            ModifyPoint(Center, anim, frame);
        }
