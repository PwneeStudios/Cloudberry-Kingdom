...
namespace CloudberryKingdom
{
    public class Rand
    {
        ...
        {
            return new Vector2(Tools.RndFloat(-Width / 2, Width / 2), Tools.RndFloat(-Width / 2, Width / 2));
        }
        ...
        {
            float f = Tools.RndFloat();
            return f < Chance;

            //return Tools.RndFloat() < Chance;
        }
        ...
        public int RndBit()
        {
            if (Tools.Rnd.NextDouble() > .5) return 1;
            else return -1;
        }
    ...
    public static class ListExtension
    {
        ...
        /// </summary>
        public static T Choose<T>(this T[] list)
        {
            return list[Tools.RndInt(0, list.Length - 1)];
        }
        ...
        public static T Choose<T>(this List<T> list)
        {
            ...
            return list[Tools.RndInt(0, list.Count - 1)];
        }
...
public static Thread EasyThread(int affinity, string name, Action action)
{
    ...
    return LoadThread;
        ...
        public static int RandomSnap(int Range, int SnapPoints)
        {
            return Tools.RndInt(0, SnapPoints) * (Range / SnapPoints);
        }
        ...
        public static int RndEnum<T>() where T : struct
        {
            return RndInt(0, Length<T>() - 1);
        }
        ...
        public void Scramble<T>(List<T> list)
        {
            for (int i = 0; i < list.Count; i++)
            {
                int j = Tools.RndInt(0, list.Count - 1);
        ...
        public static T RandomItem<T>(T[] list)
        {
        ...
        public static Vector2 RndPos(Vector2 BL, Vector2 TR)
        {
            return new Vector2(RndFloat(BL.X, TR.X), RndFloat(BL.Y, TR.Y));
        }

        public static Vector2 RndVector2(float Width)
        {
            return new Vector2(Tools.RndFloat(-Width / 2, Width / 2), Tools.RndFloat(-Width / 2, Width / 2));
        }
        ...
        /// Randomly returns true or false
        /// </summary>
        public static bool RndBool() { return RndBool(.5f); }
        public static bool RndBool(float Chance)
        {
            float f = Tools.RndFloat();
            return f < Chance;
        ...
        public static float RndFloat(float a, float b, float spacing)
        {
            if (a > b) { float temp = a; a = b; b = temp; }
        ...
        public static float RndFloat(Vector2 range)
        {
            return RndFloat(range.X, range.Y);
        }
        ...
        /// <param name="Length"></param>
        /// <returns></returns>
        public static Vector2 RndDir(float Length)
        {
            return RndDir() * RndFloat(0, Length);
        }
        ...
        public static int[] RndIndex(int Length, int NumIndices, bool[] Valid)
        {
        ...
        public static int Choose(int[] LevelCutoff, int Level)
        {
        ...
        public static int Choose(float[] Weights)
        {
        ...
        public static int ChooseNew(int Cur, int WeightA, int WeightB)
        {
        ...
        public static int ChooseNew(int Cur, int WeightA, int WeightB, int WeightC)
        {
        ...
        public static int Choose2(int WeightA, int ATag, int WeightB, int BTag)
        {
        ...
        public static int Choose(int WeightA, int WeightB)
        {
        ...
        public static int Choose(int WeightA, int WeightB, int WeightC)
        {
        ...
        public static int Choose(int WeightA, int WeightB, int WeightC, int WeightD)
        {
