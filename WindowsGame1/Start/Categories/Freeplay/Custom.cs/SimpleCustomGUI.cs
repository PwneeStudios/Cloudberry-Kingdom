...
{
    public class SimpleCustomGUI : StartMenuBase
    {
        ...
        void OnReturnFromLevel()
        {
            ...
            if (AdvancedGUI != null)
            {
                AdvancedGUI.SlideOut(PresetPos.Right, 0);
                AdvancedGUI.SlideIn();
                Active = false;
            }
        }
        ...
        void ShowObjs(bool Show)
        {
            ObjList.Include = Show;
            ObjText.Show = Show;
        }
        ...
        MenuItem Start;
        MenuList HeroList, ObjList, DiffList;
        EzText HeroText, ObjText, CheckpointsText;
...
/*
            ...
            */
            ...
            // Custom hover icon. "(Y) [Gears]"
            HoverIcon.FancyPos.SetCenter(Pos);
            MyMenu.OnSelect = () =>
                {
                    MyMenu.OnY = BringAdvanced;
                    HoverIcon.Pos = new Vector2(100000f, 0);
                };
            ...
            foreach (BobPhsx hero in Bob.HeroTypes)
            {
            ...
            //HeroList.AdditionalOnSelect = () =>
            //    {
            //        MyMenu.OnY = null;
            //        HoverIcon.Pos = new Vector2(388.8887f, 477.2223f);
            //    };
            ...
            ObjList.OnIndexSelect = () =>
            {
                ...
                //ObjIcon = ObjectIcon.CreateIcon(objtype);

                //ObjIcon.FancyPos.SetCenter(Pos);
                //ObjIcon.Pos = new Vector2(525.002f, 238.8889f);
            };
            ObjList.SetIndex(0);
            ...
            //string[] Names = { "Custom", "Training", "Normal", "Abusive", "Hardcore" };
            ...
            DiffList.AdditionalOnSelect = () =>
                {
                    MyMenu.OnY = BringAdvanced;
                    //HoverIcon.Pos = new Vector2(591f, -45.33322f);
                };
            ...
            //checkpoints = new MenuSliderBase(new EzText("x ", ItemFont));
        ...
        protected override void MyDraw()
        {
            ...
            if (!Active && AdvancedGUI != null && !AdvancedGUI.Pos.Playing)
                MyMenu.Show = false;
            else
                MyMenu.Show = true;
        ...
        {
            //Console.WriteLine("{0}, {1}", LevelSeed.NumPieces, LevelSeed.PieceLength);
